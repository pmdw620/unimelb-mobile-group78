...
public class OrderAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            view = LayoutInflater.from(context).inflate(R.layout.content_order,null);
            viewHolder=new ViewHolder();
            viewHolder.itemImage=(ImageView)view.findViewById(R.id.order_img);
            viewHolder.itemName=(TextView)view.findViewById(R.id.order_name);
        ...
        Log.d("1313113",order.getItem());
        viewHolder.itemName.setText("   "+order.getItem());
        Glide.with(context)
