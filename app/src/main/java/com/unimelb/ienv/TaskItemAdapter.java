...
public class TaskItemAdapter extends ArrayAdapter<TaskItem> {
    ...
    public TaskItemAdapter(Context context, int layoutId, List<TaskItem> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textView_up = (TextView) view.findViewById(R.id.task_desc_up);
        TextView textView_down = (TextView) view.findViewById(R.id.task_desc_down);
