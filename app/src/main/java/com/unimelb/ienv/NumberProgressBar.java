...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        float default_reached_bar_height = dp2px(2.5f);
        float default_unreached_bar_height = dp2px(2.0f);
        float default_text_size = sp2px(20);
        float default_progress_text_offset = dp2px(5.0f);
